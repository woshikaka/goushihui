...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper" ng-app="wholesaleRuleApp" ng-controller="wholesaleRuleCtrl">
			...
			<button type="submit" class="btn btn-primary" style="margin-top: 10px" ng-click="save()">修改批发规则</button>
		</div>
	</div>
</body>
</html>
